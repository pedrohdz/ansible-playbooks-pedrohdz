...
> [!INFO] Note for AI agents
>
> AI coding agents are expected to follow these conventions strictly.
>
> Any change that would violate these rules should be flagged clearly and
...
- Put **OR** logic inside a _single_ condition (since list items do not OR
  together).
...
When you need quotes _inside_ a string, prefer:
